...
public class AddressBookController {
    ...
    private void openAdd(){   
       view.getMainGUIFrame().setVisible(false);
        ...
        choiceListener = new ActionListener() {
            ...
            String address = contactDetailsPanel.getAddresField().getText();
   ...
   */
    ...
    private void openEdit(){
        ...
        dialog.getPanel().setAddres(detailPanel.getAddresField().getText());
        view.getMainGUIFrame().setVisible(false);
        choiceListener = new ActionListener() {
            @Override
            public void actionPerformed(ActionEvent e) {
    ...
    public void loadPersons()       
    {
        ...
        nlp.getJList().addListSelectionListener(new ListSelectionListener()
         ...
         detailPanel.getAddresField().setEditable(false);
        }
    }  //loadPersons ends
